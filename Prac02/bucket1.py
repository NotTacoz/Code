...
bucket2 = ['Visit stoneghenge', 'Drive a motorocycle on the Great Wall of China', 'Go on a Safari', 'Visit the Taj Mahal', 'Sit on the Great Egyptian Pyramids', 'Find the joy in your life']
